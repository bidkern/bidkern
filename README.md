...
This GitHub is a small portfolio of operations-focused & hobby projects. The featured work currently shows CSV validation, scoring logic, ranked outputs, SQLite reporting, and an inventory workflow prototype.
...
Sales support, customer communication, account coordination, coaching, retail operations, B2B outreach, KPI tracking, and practical Excel/SQL/Python workflow projects.
